 ...
 * Signature: ()I
 */ extern "C" JNIEXPORT jint JNICALL Java_com_example_opengl_Jni_startAudioPlayer(
        JNIEnv *, jclass) {
    pthread_t thread;
 ...
 * Signature: ()I
 */ extern "C" JNIEXPORT jint JNICALL Java_com_example_opengl_Jni_destroyEngine(
        JNIEnv *, jclass) {
 ...
 * Signature: ()I
 */ extern "C" JNIEXPORT jint JNICALL Java_com_example_opengl_Jni_stopAudioPlayer(
        JNIEnv *, jclass) {
